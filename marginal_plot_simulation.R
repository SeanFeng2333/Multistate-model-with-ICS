...
wsf.weibull.pw.beta12.t3.lci <- wsf.weibull.pw.est$beta12.t3+qnorm(0.025)*wsf.weibull.pw.se$beta12.t3
wsf.weibull.pw.beta12.t3.uci <- wsf.weibull.pw.est$beta12.t3+qnorm(0.975)*wsf.weibull.pw.se$beta12.t3
HR12.wsf.weibull.pw.t3.lci <- mean(exp(wsf.weibull.pw.beta12.t3.lci))
HR12.wsf.weibull.pw.t3.uci <- mean(exp(wsf.weibull.pw.beta12.t3.uci))

wsf.weibull.pw.beta12.t4.lci <- wsf.weibull.pw.est$beta12.t4+qnorm(0.025)*wsf.weibull.pw.se$beta12.t4
wsf.weibull.pw.beta12.t4.uci <- wsf.weibull.pw.est$beta12.t4+qnorm(0.975)*wsf.weibull.pw.se$beta12.t4
HR12.wsf.weibull.pw.t4.lci <- mean(exp(wsf.weibull.pw.beta12.t4.lci))
HR12.wsf.weibull.pw.t4.uci <- mean(exp(wsf.weibull.pw.beta12.t4.uci))
...
wsf.weibull.pw.beta23.t3.lci <- wsf.weibull.pw.est$beta23.t3+qnorm(0.025)*wsf.weibull.pw.se$beta23.t3
wsf.weibull.pw.beta23.t3.uci <- wsf.weibull.pw.est$beta23.t3+qnorm(0.975)*wsf.weibull.pw.se$beta23.t3
HR23.wsf.weibull.pw.t3.lci <- mean(exp(wsf.weibull.pw.beta23.t3.lci))
HR23.wsf.weibull.pw.t3.uci <- mean(exp(wsf.weibull.pw.beta23.t3.uci))

wsf.weibull.pw.beta23.t4.lci <- wsf.weibull.pw.est$beta23.t4+qnorm(0.025)*wsf.weibull.pw.se$beta23.t4
wsf.weibull.pw.beta23.t4.uci <- wsf.weibull.pw.est$beta23.t4+qnorm(0.975)*wsf.weibull.pw.se$beta23.t4
HR23.wsf.weibull.pw.t4.lci <- mean(exp(wsf.weibull.pw.beta23.t4.lci))
HR23.wsf.weibull.pw.t4.uci <- mean(exp(wsf.weibull.pw.beta23.t4.uci))
...
HR12plot_tau1 <- ggplot(data.frame(t=c(0, 10)), aes(x=t)) + 
  stat_function(fun=HR12.true, aes(linetype="TRUE")) + 
  geom_line(aes(y = HR12.wsf.weibull[1], linetype = "WSF")) +
  geom_line(aes(x=c(0,4), y = HR12.wsf.weibull.t1[1], linetype = "2-piece WSF")) +
  geom_line(aes(x=c(4,10), y = HR12.wsf.weibull.t2[1], linetype = "2-piece WSF")) +
  geom_ribbon(aes(ymin= HR12.wsf.weibull.lci, ymax=HR12.wsf.weibull.uci), linetype=2, alpha=0.1, fill="grey50")+
  geom_ribbon(aes(x=c(0,4), ymin= HR12.wsf.weibull.pw.t1.lci, ymax=HR12.wsf.weibull.pw.t1.uci), linetype=2, alpha=0.1, fill="grey20")+
  geom_ribbon(aes(x=c(4,10), ymin= HR12.wsf.weibull.pw.t2.lci, ymax=HR12.wsf.weibull.pw.t2.uci), linetype=2, alpha=0.1, fill="grey20")+
  ...
  theme(plot.title = element_text(hjust = 0.5), 
        ...
        legend.key = element_rect(fill = c("white")),
        panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_blank(), axis.line = element_line(colour = "black")) 


HR23plot_tau1 <- ggplot(data.frame(t=c(0, 10)), aes(x=t)) + 
  stat_function(fun=HR23.true, aes(linetype="TRUE")) + 
  geom_line(aes(y = HR23.wsf.weibull[1], linetype = "WSF")) +
  geom_line(aes(x=c(0,4), y = HR23.wsf.weibull.t1[1], linetype = "2-piece WSF")) +
  geom_line(aes(x=c(4,10), y = HR23.wsf.weibull.t2[1], linetype = "2-piece WSF")) +
  geom_ribbon(aes(ymin= HR23.wsf.weibull.lci, ymax=HR23.wsf.weibull.uci), linetype=2, alpha=0.1, fill="grey50")+
  geom_ribbon(aes(x=c(0,4), ymin= HR23.wsf.weibull.pw.t1.lci, ymax=HR23.wsf.weibull.pw.t1.uci), linetype=2, alpha=0.1, fill="grey20")+
  geom_ribbon(aes(x=c(4,10), ymin= HR23.wsf.weibull.pw.t2.lci, ymax=HR23.wsf.weibull.pw.t2.uci), linetype=2, alpha=0.1, fill="grey20")+
  scale_linetype_manual("", 
                        breaks = c("TRUE", "WSF", "2-piece WSF"),
                        values = c("solid","dotted", "dashed")) +
  ylim(0.8,1.7)+
...
cumhaz12plot_tau1 <- ggplot(data.frame(t=c(0, 10)), aes(x=t)) + 
  stat_function(fun=cumhaz12.true, aes(linetype="TRUE")) + 
  stat_function(fun=cumhaz12.wsf.weibull, aes(linetype="WSF")) + 
  stat_function(fun=cumhaz12.wsf.weibull.pw, aes(linetype="2-piece WSF")) + 
  scale_linetype_manual("", 
                        breaks = c("TRUE", "WSF", "2-piece WSF"),
                        values = c("solid","dotted", "dashed")) + 
  ylim(0,3)+
...
cumhaz23plot_tau1 <- ggplot(data.frame(t=c(0, 10)), aes(x=t)) + 
  stat_function(fun=cumhaz23.true, aes(linetype="TRUE")) + 
  stat_function(fun=cumhaz23.wsf.weibull, aes(linetype="WSF")) + 
  stat_function(fun=cumhaz23.wsf.weibull.pw, aes(linetype="2-piece WSF")) + 
  scale_linetype_manual("", 
                        breaks = c("TRUE", "WSF", "2-piece WSF"),
                        values = c("solid","dotted", "dashed")) + 
  ylim(0,3)+
...
HR12plot_tau10 <- ggplot(data.frame(t=c(0, 10)), aes(x=t)) + 
  stat_function(fun=HR12.true_tau10, aes(linetype="TRUE")) + 
  geom_line(aes(y = HR12.wsf.weibull_tau10[1], linetype = "WSF")) +
  geom_line(aes(x=c(0,4), y = HR12.wsf.weibull.t1_tau10[1], linetype = "2-piece WSF")) +
  geom_line(aes(x=c(4,10), y = HR12.wsf.weibull.t2_tau10[1], linetype = "2-piece WSF")) +
  geom_ribbon(aes(ymin= HR12.wsf.weibull.lci, ymax=HR12.wsf.weibull.uci), linetype=2, alpha=0.1, fill="grey50")+
  geom_ribbon(aes(x=c(0,4), ymin= HR12.wsf.weibull.pw.t1.lci, ymax=HR12.wsf.weibull.pw.t1.uci), linetype=2, alpha=0.1, fill="grey20")+
  geom_ribbon(aes(x=c(4,10), ymin= HR12.wsf.weibull.pw.t2.lci, ymax=HR12.wsf.weibull.pw.t2.uci), linetype=2, alpha=0.1, fill="grey20")+
  scale_linetype_manual("", 
...
HR23plot_tau10 <- ggplot(data.frame(t=c(0, 10)), aes(x=t)) + 
  stat_function(fun=HR23.true_tau10, aes(linetype="TRUE")) + 
  geom_line(aes(y = HR23.wsf.weibull_tau10[1], linetype = "WSF")) +
  geom_line(aes(x=c(0,4), y = HR23.wsf.weibull.t1_tau10[1], linetype = "2-piece WSF")) +
  geom_line(aes(x=c(4,10), y = HR23.wsf.weibull.t2_tau10[1], linetype = "2-piece WSF")) +
  geom_ribbon(aes(ymin= HR23.wsf.weibull.lci, ymax=HR23.wsf.weibull.uci), linetype=2, alpha=0.1, fill="grey70")+
  geom_ribbon(aes(x=c(0,4), ymin= HR23.wsf.weibull.pw.t1.lci, ymax=HR23.wsf.weibull.pw.t1.uci), linetype=2, alpha=0.1, fill="grey20")+
  geom_ribbon(aes(x=c(4,10), ymin= HR23.wsf.weibull.pw.t2.lci, ymax=HR23.wsf.weibull.pw.t2.uci), linetype=2, alpha=0.1, fill="grey20")+
  scale_linetype_manual("", 
                        breaks = c("TRUE", "WSF", "2-piece WSF"),
...
cumhaz12plot_tau10 <- ggplot(data.frame(t=c(0, 10)), aes(x=t)) + 
  stat_function(fun=cumhaz12.true_tau10, aes(linetype="TRUE")) + 
  stat_function(fun=cumhaz12.wsf.weibull_tau10, aes(linetype="WSF")) + 
  stat_function(fun=cumhaz12.wsf.weibull.pw_tau10, aes(linetype="2-piece WSF")) + 
  scale_linetype_manual("", 
                        breaks = c("TRUE", "WSF", "2-piece WSF"),
                        values = c("solid","dotted", "dashed")) +
  ylim(0,3)+
...
cumhaz23plot_tau10 <- ggplot(data.frame(t=c(0, 10)), aes(x=t)) + 
  stat_function(fun=cumhaz23.true_tau10, aes(linetype="TRUE")) + 
  stat_function(fun=cumhaz23.wsf.weibull_tau10, aes(linetype="WSF")) + 
  stat_function(fun=cumhaz23.wsf.weibull.pw_tau10, aes(linetype="2-piece WSF")) + 
  scale_linetype_manual("", 
                        breaks = c("TRUE", "WSF", "2-piece WSF"),
                        values = c("solid","dotted", "dashed")) +
  ylim(0,3)+
